...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var kmd_client, wallets, wallet_name, wallet_pw, wallet_id, wallet_handle, wallet_addresses, algodClient, hr;
        var _this = this;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    if (DEBUG)
                        console.log('wallet_handle:', wallet_handle);
                ...
                case 3:
                    ...
                    algodClient = new algosdk_1["default"].Algodv2(algod_token, algod_server, algod_server_port);
