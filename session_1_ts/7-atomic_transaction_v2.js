...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var kmd_client, wallet_name, wallet_pw, wallet_id, wallet_handle, wallet_addresses, addr1, addr2, addr3, algod_client, asset_index, params, addr1_sk, acct1, addr2_sk, acct2, atc, txn1, txn1_signer, txn2, txn2_signer, result, hr;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 6:
                    ...
                    txn1 = algosdk_1["default"].makePaymentTxnWithSuggestedParamsFromObject({
                        from: addr2,
                        to: addr1,
                        amount: algosdk_1["default"].algosToMicroalgos(0.15),
                        suggestedParams: params
                    });
                    txn1_signer = algosdk_1["default"].makeBasicAccountTransactionSigner(acct2);
                    // add txn and signer to Atomic Transaction Composer
                    atc.addTransaction({ txn: txn1, signer: txn1_signer });
                    txn2 = algosdk_1["default"].makeAssetTransferTxnWithSuggestedParamsFromObject({
                        suggestedParams: params,
                        from: addr1,
                        to: addr2,
                    ...
                    txn2_signer = algosdk_1["default"].makeBasicAccountTransactionSigner(acct1);
                    // add txn and signer to atc
                    atc.addTransaction({ txn: txn2, signer: txn2_signer });
                    return [4 /*yield*/, atc.execute(algod_client, 7)];
                case 7:
                    result = _a.sent();
                    if (DEBUG)
                        console.log(result);
