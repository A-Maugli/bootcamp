...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var kmd_client, wallet_name, wallet_pw, wallet_id, wallet_handle, wallet_addresses, addr1, addr2, addr3, algod_client, asset_index, params, unsigned_txn, addr2_sk, signed_txn, tx_id, roundTimeout, confirmed_txn, hr;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 4:
                    ...
                    unsigned_txn = algosdk_1["default"].makeAssetTransferTxnWithSuggestedParamsFromObject({
                    ...
                    return [4 /*yield*/, kmd_client.exportKey(wallet_handle.wallet_handle_token, '', addr2)];
                case 5:
                    addr2_sk = _a.sent();
                    if (DEBUG)
                        console.log('addr1_sk:', addr2_sk);
                    return [4 /*yield*/, unsigned_txn.signTxn(addr2_sk.private_key)];
                case 6:
                    signed_txn = _a.sent();
                    if (DEBUG)
