...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var kmd_client, wallets, wallet_name, wallet_pw, wallet_id, wallet_handle, wallet_addresses, addr1, addr2, addr3, algod_client, params, unsigned_txn, addr1_sk, signed_txn, tx_id, roundTimeout, confirmed_txn, asset_index, hr;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    ...
                    unsigned_txn = algosdk_1["default"].makeAssetCreateTxnWithSuggestedParamsFromObject({
                        from: addr1,
                ...
                case 7:
                    ...
                    fs.writeFile('5_asset_index.txt', asset_index, function (err) {
                        if (err) {
                            console.log(err);
                        }
                        else {
